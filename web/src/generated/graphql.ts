...
/** placeholder for update columns of table "records" (current role has no relevant permissions) */
...
export type GetRecordsQuery = {
  __typename?: "query_root";
  records: Array<{ __typename?: "records"; id: number; sgf_text: string }>;
};
...
export type SelectRecordsQuery = {
  __typename?: "query_root";
  users_by_pk?: {
    __typename?: "users";
    records: Array<{ __typename?: "records"; id: number; sgf_text: string }>;
...
export type DeleteRecordMutation = {
  __typename?: "mutation_root";
  delete_records_by_pk?: { __typename?: "records"; id: number } | null;
};
